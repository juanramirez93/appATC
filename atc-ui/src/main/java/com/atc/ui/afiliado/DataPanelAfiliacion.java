...
public class DataPanelAfiliacion extends JPanelAbstract {
    ...
    private void personalizeLayout() {
        ...
        jComponentArray.add(panePar);
        jComponentArray.add(vPesadosField);
        jComponentArray.add(panePes);
    ...
    private void initializeVariables() {
        ...
        tipoField = new JComboBox<>(StringsConstants.AFILIADO_TYPE);
        ...
        panePar = new JScrollPane(placasParticularesField);
        ...
        panePes = new JScrollPane(placasPesadosField);
